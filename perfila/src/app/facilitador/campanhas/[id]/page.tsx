    ...
    <>
      ...
      <Card padding="none" scrollX>
        {mapas.length > 0 ? (
          ...
          <EmptyState>
            <p>
              Esta turma ainda não recebeu passaportes. O envio rápido cria vários de uma vez,
              todos ligados a ela.
            </p>
            <Button href="/facilitador/envio-rapido" variant="primary" icon={<Icon name="plus" />}>
              Enviar passaportes
            </Button>
          </EmptyState>
        )}
